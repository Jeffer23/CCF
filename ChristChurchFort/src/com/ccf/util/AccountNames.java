...
public class AccountNames {
	...
	public static final String BuildingAccount = "Building Account";
	public static final String GraveyardAccount = "Graveyard Account";
	public static final String EducationalFundAccount = "Educational Fund Account";
	...
	public static final String BankBuildingAccount = "Bank Building Account";
	public static final String BankGraveyardAccount = "Bank Graveyard Account";
	public static final String BankEducationalFundAccount = "Bank Educational Fund Account";
}
